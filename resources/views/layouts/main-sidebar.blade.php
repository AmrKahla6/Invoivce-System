				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">الفواتيرالمدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">الفواتير غير المدفوعه</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">تقاريرالعملاء</a></li>
						</ul>
                    </li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">اضافه قسم</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">اضافه منتج</a></li>
						</ul>
					</li>
				</ul>
			</div>
